...
namespace GrpcWpf.VM
{
    public partial class ViewModel : ObservableObject
    {
        ...
        private void OpenDb()
        {
            ...
            {
                //Test service
                Family user1 = new Family { Name = "Труба", Id = 1, Category = "Трубы" };
                Family user2 = new Family { Name = "Воздуховод", Id = 2, Category = "Воздуховоды" };
                db.Families.AddRange(user1, user2);
                db.SaveChanges();
                ...
                if (directory.Exists)
                {
                    ...
                    foreach (var dir in directories)
                    {
                        ...
                        foreach (var dllFile in dllFiles)
                        {
                            ...
                            var plugin = new PluginModel(name, fullAssPath);
                            plugins.Add(plugin);
                        }
                    }
                }
